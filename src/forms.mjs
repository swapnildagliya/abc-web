...
export const BOOKING_FIELDS = [
  ...
  { name: "Budget", label: "Budget", required: true, hint: "A range is fine. It tells us what shape of company fits." },
  { name: "Heard about us", label: "How did you hear about us?", type: "select", required: true,
