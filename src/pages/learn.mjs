    ...
    <section class="scene-pad t-paper" id="at-home" data-scene data-cue="further afield">
      ...
      <div class="intro">
        ...
        <div class="intro-copy fx">
          ...
          <p>Private one-to-one coaching and guest workshops are booked directly with Swapnil at swapnil.dance, built around your style, questions and pace.</p>
          <div class="button-row">
            <a class="button button-dark" href="../learn-to-dance-bollywood/">Start the free course <span>↗</span></a>
            <a class="button button-outline" href="https://swapnil.dance/workshops/" target="_blank" rel="noopener">Learn with Swapnil <span>↗</span></a>
          </div>
        </div>
      </div>
      <div class="card-grid">
    ...
    <section class="scene-pad t-paper" data-scene data-cue="all the detail">
      ...
      <div class="folds fx">
        ...
        <details id="online"><summary>Learn online</summary><div class="fold-body prose">
          ...
          <h3>How it works</h3>
          <p>Sessions include live feedback, focused drills and practice notes. Coaching is booked directly with Swapnil — mention your time zone and what you want to learn when you get in touch.</p>
          <p><a class="button button-yellow" href="https://swapnil.dance/workshops/" target="_blank" rel="noopener">Book coaching with Swapnil <span>↗</span></a></p>
        </div></details>
        <details id="garba-europe"><summary>Garba workshops across Europe</summary><div class="fold-body prose">
          ...
          <p>Workshops can be adapted for studios, festivals, cultural organisations, schools and community groups across Belgium and Europe, and are booked directly with Swapnil.</p>
          <p><a class="button button-yellow" href="https://swapnil.dance/workshops/" target="_blank" rel="noopener">Bring a Garba workshop to your city <span>↗</span></a></p>
        </div></details>
      </div>
    </section>
