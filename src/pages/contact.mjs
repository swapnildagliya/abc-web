...
const body = `
    ...
    <section class="scene-pad t-paper" id="refunds" data-scene data-cue="small print">
      ...
      <div class="folds fx">
        ...
        <details><summary>Force majeure and administration</summary><div class="fold-body prose"><p>If ABC or Shoonya Dance Centre cancels a class, workshop or session, a replacement or rescheduled session is provided.</p><p>In the event of force majeure — war, uprising, fire and the like — refunds are not possible.</p><p>Where a refund is granted as an exception, an administration fee of €25 is deducted from the amount refunded.</p></div></details>
      </div>
    </section>
