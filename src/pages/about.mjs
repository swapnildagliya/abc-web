...
const body = `
    <section class="inner-hero t-bone" id="top" aria-labelledby="page-title" data-scene data-cue="roots">
      ...
      <div class="inner-hero-copy">
        ...
        <div class="button-row fx">
          <a class="button button-dark" href="#ensemble">Meet the company <span>↓</span></a>
    ...
    <section class="scene-pad t-paper" id="company" data-scene data-cue="on purpose">
      ...
      <div class="card-grid">
        ...
        <article class="card fx"><small>03 · Exchange</small><h3>Ghent meets a wider scene</h3><p>Touring, guest teaching and the festival connect a local company to artists and audiences across Europe.</p></article>
      </div>
    </section>

    <section class="scene-pad t-night spot" id="ensemble" data-scene data-stage data-cue="the ensemble">
    ...
    <section class="scene-pad t-bone media-led" id="story" data-scene data-scrub data-cue="the founder">
      ...
      <div>
        ...
        <p class="fx" style="max-width:36em">In Ghent, he co-founded Shoonya Dance Centre, founded ABC in 2017 and began the Gent India Dans Festival in 2023.</p>
    ...
    <section class="scene-pad t-yellow" data-scene data-cue="a short history">
      ...
      <div class="act-list">
        ...
        <article class="fx"><small>2023</small><span><strong>Gent India Dans Festival begins</strong><em>First edition</em></span></article>
        <a class="fx" href="https://www.youtube.com/watch?v=2efQqxnI8s0" target="_blank" rel="noopener"><small>2024</small><span><strong>The Four Loves</strong><em>Full-length production · watch the trailer</em></span><b>↗</b></a>
        <a class="fx" href="../sangam/"><small>2026</small><span><strong>Sangam</strong><em>New production · 7–8 Nov 2026 · Ghent</em></span><b>↗</b></a>
      </div>
      <div class="button-row fx" style="margin-top:1.8rem">
        <a class="button button-dark" href="../whats-on/">See ABC live <span>→</span></a>
        <a class="button button-outline" href="../contact/#book">Book the company <span>↗</span></a>
      </div>
    </section>
`;
